...
def main():
    ...
    # Build the model
    model = build_spark('models/resnet50_1kpretrained_0epoch_timm_style.pth') # Change this to the path of your own pretrained model
    print("model built")
    ...
    plot_loss_and_accuracy_matplotlib(train_losses, val_losses, train_accuracies, val_accuracies)
...
def plot_loss_and_accuracy_matplotlib(train_losses, val_losses, train_accuracies, val_accuracies):
    epochs = range(1, len(train_losses) + 1)
